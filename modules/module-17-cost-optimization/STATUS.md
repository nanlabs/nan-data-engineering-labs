...
1. **exercises/01-cost-analysis/cost_explorer_analysis.py** (~370 lines)
...
2. **exercises/01-cost-analysis/cur_analysis.py** (~280 lines)
...
3. **exercises/01-cost-analysis/cost_tagging.py** (~340 lines)
...
4. **exercises/02-storage-optimization/lifecycle_policies.py** (~280 lines)
...
5. **exercises/02-storage-optimization/intelligent_tiering.py** (~320 lines)
...
6. **exercises/02-storage-optimization/storage_analytics.py** (~350 lines)
...
7. **exercises/03-compute-purchasing/ri_analysis.py** (~400 lines)
...
8. **exercises/03-compute-purchasing/savings_plans.py** (~350 lines)
...
9. **exercises/03-compute-purchasing/spot_instances.py** (~400 lines)
...
10. **exercises/04-right-sizing/compute_optimizer.py** (~430 lines)
...
11. **exercises/04-right-sizing/cloudwatch_metrics.py** (~480 lines)
...
12. **exercises/04-right-sizing/recommendations.py** (~480 lines)
...
13. **exercises/05-serverless-costs/lambda_cost_analysis.py** (~400 lines)
...
14. **exercises/05-serverless-costs/fargate_vs_ec2.py** (~380 lines)
...
15. **exercises/05-serverless-costs/api_gateway_costs.py** (~400 lines)
...
16. **exercises/06-cost-governance/budget_alerts.py** (~400 lines)
...
17. **exercises/06-cost-governance/cleanup_automation.py** (~440 lines)
...
18. **exercises/06-cost-governance/finops_kpis.py** (~400 lines)
...
1. **theory/concepts.md** (~650 lines)
...
2. **theory/architecture.md** (~700 lines)
...
3. **theory/best-practices.md** (~650 lines)
...
4. **theory/resources.md** (~280 lines)
...
1. **infrastructure/docker-compose.yml** (~120 lines)
...
2. **infrastructure/init-aws.sh** (~280 lines)
...
2. **scripts/validate.sh** (~300 lines)
...
3. **scripts/cleanup.sh** (~200 lines)
...
1. **data/sample/cost-usage-report.csv** (~200 lines)
...
2. **data/sample/cost-allocation-tags.json** (~200 lines)
...
1. **validation/test_cost_optimization.py** (~400 lines)
