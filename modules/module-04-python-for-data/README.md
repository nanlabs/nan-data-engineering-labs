...
5. **Exercise 03**: File Operations - CSV, JSON, Parquet, Excel
6. **Practice**: Load and explore the datasets in`data/raw/`

### Fase 3: Pandas y Transformaciones (5-6 horas)
7. **Exercise 04**: Pandas Fundamentals - DataFrames, Series, indexing
8. **Exercise 05**: Data Transformation - Merge, group, pivot, reshape
9. **Mini Project**: Build a complete transformation pipeline

### Phase 4: Production (2-3 hours)
10. **Exercise 06**: Error Handling - Try/except, logging, debugging
